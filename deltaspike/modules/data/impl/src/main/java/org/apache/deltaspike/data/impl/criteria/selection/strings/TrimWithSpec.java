...
public class TrimWithSpec<P> extends SingularAttributeSelection<P, String>
{

    private final CriteriaBuilder.Trimspec trimspec;

    public TrimWithSpec(CriteriaBuilder.Trimspec trimspec, SingularAttribute<? super P, String> attribute)
    {
        super(attribute);
    ...
    {
        return builder.trim(trimspec, path.get(getAttribute()));
    }
}
